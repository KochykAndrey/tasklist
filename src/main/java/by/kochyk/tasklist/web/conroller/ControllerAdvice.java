...
import by.kochyk.tasklist.domain.exception.AccessDeniedException;
import by.kochyk.tasklist.domain.exception.ExceptionBody;
...
public class ControllerAdvice {
    ...
    @ResponseStatus(HttpStatus.BAD_REQUEST)
    public ExceptionBody handleAuthenticationException(final Exception e) {
        return new ExceptionBody("Authentication failed.");
    }

    @ExceptionHandler(ImageUploadException.class)
    @ResponseStatus(HttpStatus.BAD_REQUEST)
    public ExceptionBody handleImageUploadException(final Exception e) {
        return new ExceptionBody(e.getMessage());
    }
